...
const RoomFilter = ({rooms}) => {
    ...
    const{
        handleChange,type,capacity,price,maxPrice,minPrice,minSize,maxSize,breakfast,pets}=context;
    ...
    return (  <section className='filter-container'>
        ...
        <form className='filter-form'>
            <div className="form-group">
                ...
                <select name="type" id="type" value={type} className="form-control" onChange={handleChange} defaultValue="alll">
                {types}</select>
            </div>
            <div className="form-group">
